...
const app = {
    ...
    updatePageData() {
        ...
        this.saveData();
        this.renderPagesList(); // Live sync
        this.renderPreview();
    },
    ...
    exportAsPDF() {
        ...
        const returnToEditor = !document.getElementById('view-viewer').classList.contains('active');
        if (returnToEditor) this.openViewer();

        setTimeout(() => {
            alert("Instructions:\n1. Ensure 'Background graphics' is ENABLED in print settings.\n2. Save as PDF.");
            window.print();
            if (returnToEditor) this.closeViewer();
        }, 800);
    }
};
